  ...
  <div class="container-fluid">
    ...
    <form class="form-horizontal" action="" method="POST">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="internal_cost_per_worker" name="internal_cost_per_worker"
            required>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="internal_hours_per_day_per_worker"
            name="internal_hours_per_day_per_worker" required>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="internal_days_per_worker" name="internal_days_per_worker"
            required>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="external_cost_per_worker" name="external_cost_per_worker"
            required>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="external_hours_per_day_per_worker"
            name="external_hours_per_day_per_worker" required>
