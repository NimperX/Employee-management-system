     ...
     <div class="content">
      ...
      @method('PUT')
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                            <select class="form-control" name="machine_type" id="machine_type_select" value="{{$machine->machine_type}}" required>
                                      ...
                                      <option value="Other"> Other </option>   
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                              <input type="radio" name="machine_availability" value="Not available" value="{{$machine->machine_availability}}">Available</label>
                                              &nbsp &nbsp &nbsp &nbsp 
                                            <label class="radio-inline">
                                              <input type="radio" name="machine_availability" value="Available" value="{{$machine->machine_availability}}"> Not available</label>
                                          </div>

                                          <div class="form-group">
                                            <label class="control-label col-sm-2" for="projectidlbl">Project ID:</label>
                                              <div class="col-sm-10">
                                              <input type="text" class="form-control" name="project_id"  value="{{$machine->project_id}}">
                                              </div>
                                            </div>
                                            ...
                                            <label class="control-label col-sm-2" for="projectnamelbl">Project name:</label>
                                              <div class="col-sm-10">
                                              <input type="text" class="form-control" name="project_name" value="{{$machine->project_name}}">
                                              </div>
                                            </div>
                                          ...
                                          <div class="col-sm-10">
                                                <input type="text" placeholder="Work start date" onfocus="(this.type='date')" onblur="(this.type='text')" name="work_start_date"  value="{{$machine->work_start_date}}">
                                                </div>
                                        </div>
                                                <div class="form-group">
                                                <label class="control-label col-sm-2" for="projecttypetxt"> Work end date: </label>
                                          <div class="col-sm-10">
                                                <input type="text" placeholder="Work end date" onfocus="(this.type='date')" onblur="(this.type='text')" name="work_end_date" value="{{$machine->work_end_date}}">
